        ...
        card.addEventListener("click", () => {
            if (card.classList.contains("web")) {
                ...
                portfolioView({
                    ...
                    image: [
                        "resources/img/portfolios/PYTHON/EDYST-PYTHON.jpg",
                        "resources/img/portfolios/PYTHON/COURSERA-PYTHON.jpg",
                        "resources/img/portfolios/PYTHON/GOOGLE-PYTHON.jpg",
                        "resources/img/portfolios/PYTHON/INEURON-PYTHON.jpg",
                        "resources/img/portfolios/PYTHON/infosys-dsa-python.jpg",
                        "resources/img/portfolios/PYTHON/KAGGLE-PYTHON.JPG"
                    ],
                });
